...
void MainWindow::createActions()
{
    ...
    fileMenu->addAction(QStringLiteral("New"), [this]() {newFile(); }, QKeySequence::New);
    fileMenu->addAction(QStringLiteral("Open"), [this]() {open(); }, QKeySequence::Open);
    ...
    fileMenu->addAction(QStringLiteral("Exit"), []() {qApp->closeAllWindows(); }, QKeySequence::Close);
    ...
    connect(mainTextEdit->document(), &QTextDocument::contentsChanged,
        [this]() { setWindowModified(true); erdView->documentWasModified(); });
